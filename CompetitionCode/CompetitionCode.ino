...
//////////   VARIABLES   ////////////
  ...
  // SERVOS
    ...
    int railsUp = 120;          // Monkey Rails up position, degrees
    int railsBack = 155;        // Monkey Rails back position, degrees
    int railsForward = 25;      // Monkey Rails forward position, degrees
    int railsMR = 138;
 ...
 // HALL SENSOR
    ...
    double hallTol = 0.1;  // Percent of range for the hall sensor to see to activate it, e.g., 0.2 = 20%
 ...
 // WALL FOLLOW
    ...
    #define WFDist  12.3 // Wall follow distance, cm
